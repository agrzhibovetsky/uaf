    ...
    <tr>
        ...
        <td align="left">
            <asp:UpdatePanel runat="server" RenderMode="Inline">
                <ContentTemplate>
                    <asp:DropDownList runat="server" ID="ddlTagType" AutoPostBack="true" onselectedindexchanged="ddlTagType_SelectedIndexChanged"></asp:DropDownList>
                    <asp:UpdatePanel runat="server" RenderMode="Inline">
                        <ContentTemplate>
                            <asp:DropDownList runat="server" ID="ddlTagValue"></asp:DropDownList>
