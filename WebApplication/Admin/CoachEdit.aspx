<%@ Page Title="" Language="C#" MasterPageFile="~/WebApplication/Site.master" AutoEventWireup="true" Inherits="UaFootball.WebApplication.CoachEdit" Codebehind="CoachEdit.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table cellpadding="4" class="editform">
        <tr>
            <th colspan="2" align="left">Редактировать тренера</th>
        </tr>
        <tr>
            <td align="right">
                Имя
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="tbFirstName" ErrorMessage="Введите имя тренера" CssClass="editFormError"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ControlToValidate="tbLastName" ErrorMessage="Введите фамилию тренера" CssClass="editFormError"></asp:RequiredFieldValidator>
            </td>
        </tr>
