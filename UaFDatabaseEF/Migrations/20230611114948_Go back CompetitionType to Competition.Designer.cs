...
namespace UaFDatabaseEF.Migrations
{
    ...
    [Migration("20230611114948_Go back CompetitionType to Competition")]
    partial class GobackCompetitionTypetoCompetition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UaFDatabaseEF.Models.CompetitionEditionStages", b =>
                {
                    b.Property<int>("CompetitionEditionStageId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("CompetitionStageKind")
                        .HasColumnName("CompetitionEditionStage_Kind")
                        .HasMaxLength(5);
                    ...
                    b.HasIndex("CompetitionStageRuleId");

                    b.ToTable("CompetitionEditionStages");
                });
            ...
            modelBuilder.Entity("UaFDatabaseEF.Models.CompetitionStageRules", b =>
                {
                    b.Property<int>("CompetitionStageRuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("CompetitionStageRule_Id")
                    ...
                    b.HasKey("CompetitionStageRuleId");

                    b.ToTable("CompetitionStageRules");
                });
            ...
            modelBuilder.Entity("UaFDatabaseEF.Models.Matches", b =>
                {
                    ...
                    b.Property<int?>("CompetitionEditionStageId")
                        .HasColumnName("CompetitionEditionStage_Id");
                    ...
                    b.HasIndex("CompetitionEditionStageId");
            ...
            modelBuilder.Entity("UaFDatabaseEF.Models.CompetitionEditionStages", b =>
                {
                    b.HasOne("UaFDatabaseEF.Models.CompetitionEditions", "CompetitionEdition")
                        .WithMany()
            ...
            modelBuilder.Entity("UaFDatabaseEF.Models.Matches", b =>
                {
                    ...
                    b.HasOne("UaFDatabaseEF.Models.CompetitionEditionStages", "CompetitionEditionStage")
                        .WithMany("Matches")
                        .HasForeignKey("CompetitionEditionStageId");
