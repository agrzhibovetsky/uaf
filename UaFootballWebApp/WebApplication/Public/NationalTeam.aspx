<%@ Page Title="" Language="C#" MasterPageFile="~/WebApplication/Site.master" AutoEventWireup="true" CodeBehind="NationalTeam.aspx.cs" Inherits="UaFootball.WebApplication.Public.NationalTeam" %>
<%@ Register TagPrefix="UaFootball" TagName="MatchList" Src="~/WebApplication/Controls/MatchList.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title><%=DataItem.Country_Name%></title>
</asp:Content>
...
<div style="width:90%; display:flex">
    ...
    <div style="min-width:200px; min-height: 200px;">
        <asp:Image ID="iNationalTeamLogo" runat="server" />
    </div>
</div>
<div>
    <div id="tabs">
