...
namespace UaFDatabase
{
    ...
    partial void DeleteCompetitionStage(CompetitionStage instance);
		...
		public UaFootball_DBDataContext() : 
				base(global::UaFDatabase.Properties.Settings.Default.UaFootballConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<vw_CoachesList> vw_CoachesLists
		{
			get
			{
				return this.GetTable<vw_CoachesList>();
			}
		}
		
		public System.Data.Linq.Table<vw_RefereeList> vw_RefereeLists
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Coach_MatchEvent", Storage="_MatchEvents", ThisKey="CoachId", OtherKey="CoachId")]
		public EntitySet<MatchEvent> MatchEvents
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Coach_MultimediaTag", Storage="_MultimediaTags", ThisKey="CoachId", OtherKey="CoachId")]
		public EntitySet<MultimediaTag> MultimediaTags
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.vw_CoachesList")]
	public partial class vw_CoachesList
	{
		...
		private System.Nullable<int> _matchesCount;
		
		public vw_CoachesList()
		{
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_matchesCount", DbType="Int")]
		public System.Nullable<int> matchesCount
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.vw_RefereeList")]
	public partial class vw_RefereeList
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Referee_Id", DbType="Int NOT NULL")]
		public int Referee_Id
		{
			get
			{
	...
	public partial class MatchEvent : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Player1_Id;
    ...
    partial void OnPlayer1_IdChanging(System.Nullable<int> value);
    ...
    partial void OnCoachIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Player1_Id", DbType="Int")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Coach_MatchEvent", Storage="_Coach", ThisKey="CoachId", OtherKey="CoachId", IsForeignKey=true)]
		public Coach Coach
		{
			get
			{
		...
		public Player Player
		{
			...
			set
			{
							...
							|| (this._Player.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Player1_Id = default(Nullable<int>);
					}
					this.SendPropertyChanged("Player");
				}
			}
    ...
    partial void OnCoachIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Coach_MultimediaTag", Storage="_Coach", ThisKey="CoachId", OtherKey="CoachId", IsForeignKey=true)]
		public Coach Coach
		{
			get
			{
